...
angular.module('fencesForBusiness.image_service', [])
	.factory('ImageService', ['$q', '$ionicLoading', '$cordovaFileTransfer', '$rootScope', function($q, $ionicLoading, $cordovaFileTransfer, $rootScope) {

    $rootScope.imageProgress = null;

    var CLOUDINARY_CONFIGS = {
      UPLOAD_PRESET: 'edlgzaac',
      API_URL: 'https://api.cloudinary.com/v1_1/htq84tsmx/image/upload'
    };
